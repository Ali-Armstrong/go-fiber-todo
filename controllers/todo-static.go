...
// get all todos
func GetTodos_s(c *fiber.Ctx) error {
...
// Create a todo
func CreateTodo_s(c *fiber.Ctx) error {
    type Request struct {
        Title string `json:"title"`
    }
...
// get a single todo
// PARAM: id
func GetTodo_s(c *fiber.Ctx) error {
    // get parameter value
    paramId := c.Params("id")
...
// Update a todo
// PARAM: id
func UpdateTodo_s(c *fiber.Ctx) error {
    // find parameter
    paramId := c.Params("id")
...
// Delete a todo
// PARAM: id
func DeleteTodo_s(c *fiber.Ctx) error {
    // get param
    paramId := c.Params("id")
